    ...
    <br />
    	...
    	<table class="indnt1 nolines">
    	  ...
    	  <tr> <!-- ****** Choose a file ****** -->
			...
			<td>
			  <sakai:inputFileUpload id="podfile" valueChangeListener="#{podHomeBean.processFileUpload}" accept=".mp3,.m4a,.aac,.ogg,.wma" size="35" />
 	     	</td>
 	      </tr>
 	      <tr>
					<!-- ****** modifikasi ****** -->
			<td colspan="3">
				...
				<h:outputText value="#{msgs.not_audio}" styleClass="alertMessage" rendered="#{podHomeBean.displayNotAudio}" />
				<h:outputText value="#{msgs.not_1_mb}" styleClass="alertMessage" rendered="#{podHomeBean.displayNot1Mb}" />
