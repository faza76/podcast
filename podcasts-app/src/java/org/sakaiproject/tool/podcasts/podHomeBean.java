...
public class podHomeBean {
	...
	// modifikasi
	private boolean displayNot1Mb = false;
	private boolean displayNotAudio = false;
...
//				+ " source: " + source);
		...
		log.info("processFileUpload(): item: " + item
				...
				+ " length: " + fileSize + "Tipe data : " + fileContentType );

		// modifikasi
		if (fileContentType.startsWith("audio",0)){
			log.info(" benar file audio ");
...
*/
	...
	public boolean getDisplayNotAudio() {
		return displayNotAudio;
	}

	public void setDisplayNotAudio(boolean displayNotAudio) {
		this.displayNotAudio = displayNotAudio;
	}

	public boolean getDisplayNot1Mb() {
		return displayNot1Mb;
	}

	public void setDisplayNot1Mb(boolean displayNot1Mb) {
		this.displayNot1Mb = displayNot1Mb;
	}
